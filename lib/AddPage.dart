...
class AddAdvertScreen extends StatefulWidget {
  @override
  _AddAdvertScreenState createState() => _AddAdvertScreenState();
}

class _AddAdvertScreenState extends State<AddAdvertScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: Text('Додати товар'), backgroundColor: Color(0xFF16382B)),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                const SizedBox(
                    width:
                        16.0), // Add some space between image and text inputs
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      const SizedBox(
                          height: 16.0), // Add some space between text inputs
                      TextFormField(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderRadius:
                      BorderRadius.circular(34.0), // Set border radius
                ),
                focusedBorder: OutlineInputBorder(
                  borderSide: const BorderSide(
                    color: Color(0xFFFEF6EA),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Контакти',
                labelStyle:
                    TextStyle(color: Color(0xFFFEF6EA)), // Set label text color
            ...
            Row(
              children: [
                ...
                Container(
                  width: 22.0, // Set the desired height
                  padding: const EdgeInsets.all(2.0),
                  decoration: BoxDecoration(
                    border: Border.all(color: dynamicBorderColor, width: 2.0),
                  ),
                  child: Checkbox(
                ...
                const Text(
                  ' Договірна ',
                  style: TextStyle(
                      color: Color(0xFFFEF6EA)), // Set the color for the text
                ),
                Container(
                    width: 22.0,
                    height: 22.0,
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: dynamicBorderColor, width: 2.0 // Border width
                          ),
                    ),
                    child: Checkbox(
                      value: _isChecked,
                ...
                Container(
                    ...
                    child: Checkbox(
                      ...
                      onChanged: !_isChecked
                          ...
                          : null,
                      activeColor:
                          dynamicBorderColor, // Set the color for the active state
                      checkColor: Colors.black,
                    )),
                const Text(' Готівка            ',
                    style: TextStyle(color: Color(0xFFFEF6EA))),
            ...
            Container(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Додати фото галерею'),
                )),
            const SizedBox(height: 8.0),
            Container(
              width: 376,
